...
export default function HomeScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.sub}>CRUD Pruebas y Órdenes (laboratorio_api)</Text>

      <Pressable onPress={() => navigation.navigate("LabTests")} style={styles.btn}>
        <Text style={styles.btnText}>Pruebas de laboratorio (crear / listar / eliminar)</Text>
      </Pressable>

      <Pressable onPress={() => navigation.navigate("LabOrders")} style={styles.btn}>
        <Text style={styles.btnText}>Órdenes de laboratorio (crear / listar / eliminar)</Text>
      </Pressable>
